            ...
            <>
               ...
               <div className="mt-8 overflow-x-auto">
                  ...
                  {cartItems?.map((item: CartItem) => {
                     ...
                     return (
                        <div
                           key={item.id}
                           className={`w-full shadow-[0px_5px_5px_rgba(0,0,0,0.03)] dark:shadow-[2px_2px_10px_2px_rgba(255,255,255,0.1)] px-4 py-3 rounded flex items-center mt-2 ${
                              checked
               ...
               <div className="mt-6 flex justify-end">
                  <button
                     ...
                     className={`w-48 py-3 rounded font-medium text-white ${
                        isProcessing
