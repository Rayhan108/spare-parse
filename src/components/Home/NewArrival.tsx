    ...
    return (
        <div className="container mx-auto pb-5 md:pb-20">
            <div className="flex gap-2 items-center mb-5">
                ...
                <p className="text-primary font-semibold text-lg">  {t('features')}</p>
            </div>
            <div className="flex justify-between items-center mb-16">
                <h2 className="text-2xl md:text-3xl lg:text-5xl dark:text-white">  {t('newArrival')}</h2>
            </div>
                ...
                <div className="lg:w-1/2 h-[500px] lg:h-[800px] bg-cover bg-center rounded-lg relative" style={{ backgroundImage: `url(${image.src})` }}>
                    <div className=' absolute bottom-10 left-8 text-white'>
                        ...
                        <p className=' text-xl text-[#FAFAFA]'>rim for the on road.</p>
                          <Link href='/product'>
                                <button className=' text-lg border-b border-white mt-1'>  {t('shopNow')}</button>
                                </Link>
                    </div>
                </div>
