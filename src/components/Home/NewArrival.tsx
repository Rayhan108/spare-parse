    ...
    return (
        <div className="container mx-auto pb-20">
            ...
            <div className="flex justify-between items-center mb-16">
                <h2 className="text-5xl dark:text-white">New Arrival</h2>
            </div>
            <div className=' flex gap-10'>
                <div className="w-1/2 h-[800px] bg-cover bg-center rounded-lg relative" style={{ backgroundImage: `url(${image.src})` }}>
                ...
                <div className='w-1/2 h-[800px] flex flex-col gap-10'>
                    ...
                    <div className=' flex gap-10'>
                        <div className="w-1/2 h-[400px] bg-cover bg-center rounded-lg relative" style={{ backgroundImage: `url(${image.src})` }}>
                            <div className=' absolute bottom-10 left-8 text-white'>
